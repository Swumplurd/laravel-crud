    ...
    <div class="col p-5 bg-light mx-0">
        <form action="{{route('personas.update', $persona->id)}}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="paterno" name="paterno" aria-describedby="paternoHelp" value="{{$persona->paterno}}" required>
                <div id="paternoHelp" class="form-text">Ingresa tu apellido paterno</div>
            </div>
            <div class="mb-3">
                <label for="materno" class="form-label">Apellido Materno</label>
                <input type="text" class="form-control" id="materno" name="materno" aria-describedby="maternoHelp" value="{{$persona->materno}}" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nombre" name="nombre" aria-describedby="nombreHelp" value="{{$persona->nombre}}" required>
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" aria-describedby="fecha_nacimientoHelp" value="{{$persona->fecha_nacimiento}}" required>
                <div id="fecha_nacimientoHelp" class="form-text">Ingresa tu fecha_nacimiento</div>
            </div>
            <button type="submit" class="btn btn-warning align-self-end">Actualizar</button>
        </form>
    </div>
</div>
@endsection